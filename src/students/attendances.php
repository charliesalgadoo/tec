...
<html lang="es-MX">
  <head>
    ...
    <title>Tus asistencias | Alumnos</title>
  ...
  <body>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item active" href="scores.php">Calificaciones</a></li>
    ...
    <h1>Asistencias</h1>
        ...
        <label>Ver asistencia del día: </label>
        ...
        <br><br>
        <button class="btn btn-outline-secondary" data-bs-toggle="modal">Buscar</button>
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                    ...
                    <form>
                    <fieldset>
                        <td><input type="radio" id="contactChoice1" name="contact" value="email" disabled/></td>
                        <td><input type="radio" id="contactChoice1" name="contact" value="email" disabled/></td>
                    </fieldset>
                </form>
                    <td>
