...
<html lang="es-MX">
  ...
  <body>
    ...
    <h5 class="text-danger">*Nota: los cambios que hagas aquí son irreversibles. Registra con precaución.</h3>
  ...
  <div class="container">
    ...
    <button class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modalAñadir">Registrar asistencia</button>
