        ...
        <div class="table-responsive">
          <table class="table align-middle">
            ...
            <!-- incluimos el servicio para obtener los estudiantes-->
               <?php include_once("../../services/students/get_students.php"); ?>       
            </tbody>
          </table>
        </div>
      </div>
  ...
  <div class="modal fade" id="modalEliminar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form id="formEliminar" method="POST" action="../../services/students/delete_student.php">
      ...
      if (modalEstudiante) {
        modalEstudiante.addEventListener('show.bs.modal', event => {
          ...
          if (isCreateMode) {
            ...
            form.action = '../../services/students/register_student.php'; //destino de creacion
            form.reset();
            ...
            form.action = "../../services/students/update_student.php"; // indicamos que debemos enviar a update_student.php
