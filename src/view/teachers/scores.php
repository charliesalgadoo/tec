...
include_once("../../services/scores/get_scores_list.php");
  include_once('../../services/auth/auth.php');
  require_role('TEACHER'); //rol necesario
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="me.php">Yo</a>
            </li>
          ...
          <ul class="nav justify-content-end">
            <li class="nav-item">
                <li class="nav-item">
                    <a class="btn btn-outline-danger" href="../../services/logout.php">Cerrar sesión</a>
                  </li>
              </li>
          </ul>
        </div>
